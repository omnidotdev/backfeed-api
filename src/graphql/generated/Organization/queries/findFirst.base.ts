...
export const findFirstOrganizationQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    ...
    resolve: async (query, _root, args, _context, _info) =>
      await _context.db.organization.findFirst({
...
export const findFirstOrganizationQuery = defineQuery((t) => ({
  findFirstOrganization: t.prismaField(findFirstOrganizationQueryObject(t)),
}));
