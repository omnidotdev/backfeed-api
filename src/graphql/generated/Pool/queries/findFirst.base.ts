...
export const findFirstPoolQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    ...
    resolve: async (query, _root, args, _context, _info) =>
      await _context.db.pool.findFirst({
...
export const findFirstPoolQuery = defineQuery((t) => ({
  findFirstPool: t.prismaField(findFirstPoolQueryObject(t)),
}));
