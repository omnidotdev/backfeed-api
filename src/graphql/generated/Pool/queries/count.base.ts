...
export const countPoolQueryObject = defineQueryFunction((t) =>
  defineQueryObject({
    type: 'Int',
    nullable: false,
    args: {
...
export const countPoolQuery = defineQuery((t) => ({
  countPool: t.field(countPoolQueryObject(t)),
}));
