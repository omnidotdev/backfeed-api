...
export const findFirstUpvoteQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    ...
    resolve: async (query, _root, args, _context, _info) =>
      await _context.db.upvote.findFirst({
...
export const findFirstUpvoteQuery = defineQuery((t) => ({
  findFirstUpvote: t.prismaField(findFirstUpvoteQueryObject(t)),
}));
